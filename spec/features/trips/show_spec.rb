...
RSpec.describe 'trip show page', :vcr do
  ...
  xit 'has a button to view the trips flight information' do
    within("#button") do
  ...
  xit 'has a button to add your flight information' do
    within("#button") do
  ...
  xit 'has a button to update the trip' do
    within("#button") do
  ...
  xit 'has a section for Things to do' do
    within("#sights") do
      expect(page).to have_content('Things to do')
    end
  end

  xit 'has a section for Todays Itinerary' do
    within("#schedule") do
      expect(page).to have_content('Todays Itinerary')
    end
  end

  xit 'has a section for Group packing list' do #think this is extension and back burner?
